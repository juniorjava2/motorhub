    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-[#0D0F10] rounded-lg p-4">
        ...
        <div className=" flex mb-8">
          ...
          <p className="text-[14px] font-bold text-yellow-500">USD 56,000</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {[1, 2, 3].map((index) => (
          <div key={index} className="bg-indigo-900 rounded-lg p-3 flex flex-row justify-between px-8">
            <div>
            <h4 className="text-xl font-semibold mb-1">Audio to Text Task</h4>
            <p className="text-xs text-gray-400 mb-2">Start now to use the service</p>
